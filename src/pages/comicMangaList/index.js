...
class MediaList extends PureComponent {
  ...
  getData (value) {
    ...
    dispatch({
      ...
      this.setState({ mediaList: mediaListTransTo(acgn.comicMangaList.content) });
      this.setState({ hasMore: !acgn.comicMangaList.last });
    });
  }
  ...
  render() {
    ...
    return (
      <div>
        <div>
          <CustNavBar title='漫画列表' pathname={location.pathname} />
        </div>
        <ListView
